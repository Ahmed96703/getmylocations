...
export default function ReverseGeocoding() {
  return (
    <PageLayout title="Reverse Geocoding — Turn GPS Coordinates into a Street Address">
      <article>
        ...
        <p className="mt-2 text-slate-300/90 leading-relaxed">
          ...
          {' '}<Link to="/" className="text-electric-400 hover:underline">main tool</Link>, drop a manual pin,
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          {' '}<Link to="/gps-coordinates-finder" className="text-electric-400 hover:underline">GPS coordinates finder guide</Link>{' '}
          and the <Link to="/decimal-degrees-converter" className="text-electric-400 hover:underline">decimal degrees converter</Link>.
        </p>
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          ...
          <li><Link to="/decimal-degrees-converter" className="text-electric-400 hover:underline">Decimal degrees converter (DD &harr; DMS)</Link></li>
