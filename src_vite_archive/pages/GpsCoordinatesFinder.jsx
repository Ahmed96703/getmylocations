...
export default function GpsCoordinatesFinder() {
  return (
    <PageLayout title="GPS Coordinates Finder — Find Your Latitude and Longitude">
      <article>
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          <li>
            ...
            satellites in view, it triangulates a 3D position. Read our <Link to="/blog/how-gps-works" className="text-electric-400 hover:underline">how GPS works</Link> guide
          ...
          <li>
            ...
            {' '}<Link to="/blog/what-is-ip-location-and-how-accurate" className="text-electric-400 hover:underline">guide to IP location accuracy</Link>.
          </li>
        </ul>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          {' '}<Link to="/privacy-policy" className="text-electric-400 hover:underline">Privacy Policy</Link> for the full breakdown.
        </p>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          Open <Link to="/" className="text-electric-400 hover:underline font-semibold">GetMyLocations</Link>, click Allow on the prompt, and your live latitude and
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          {' '}<Link to="/fix-location-not-working" className="text-electric-400 hover:underline">troubleshooting guide</Link> and you&apos;ll be back on the
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          ...
          <li><Link to="/blog/10-uses-gps-coordinates" className="text-electric-400 hover:underline">10 surprising things you can do with a GPS coordinate</Link></li>
          <li><Link to="/fix-location-not-working" className="text-electric-400 hover:underline">Fix location not working &mdash; troubleshooting guide</Link></li>
        </ul>
      </article>
    </PageLayout>
  );
