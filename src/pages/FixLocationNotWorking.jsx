...
export default function FixLocationNotWorking() {
  return (
    <PageLayout title="Fix Location Not Working — Browser & GPS Troubleshooting Guide">
      <article>
        ...
        <p className="mt-4 text-slate-300/90 leading-relaxed">
          ...
          For more on the difference, read our <Link to="/blog/what-is-ip-location-and-how-accurate" className="text-electric-400 hover:underline">guide to IP location accuracy</Link>.
        </p>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          the <Link to="/" className="text-electric-400 hover:underline font-semibold">GetMyLocations</Link> tool. It runs entirely in your browser, requests the
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          ...
          <li><Link to="/blog/how-gps-works" className="text-electric-400 hover:underline">How GPS works — the satellite math behind your coordinates</Link></li>
          ...
          <li><Link to="/gps-coordinates-finder" className="text-electric-400 hover:underline">GPS coordinates finder — complete guide</Link></li>
        </ul>
      </article>
    </PageLayout>
  );
