...
export default function DecimalDegreesConverter() {
  return (
    <main role="main" className="max-w-3xl mx-auto px-5 py-12 prose-invert">
      <article>
        <p className="text-xs uppercase tracking-[0.18em] text-accent font-semibold">Guide &amp; Reference</p>
        ...
        <p className="mt-4 text-lg text-fg-muted leading-relaxed">
          ...
          {' '}<code className="bg-tint/10 px-1.5 py-0.5 rounded text-accent text-sm">48.858420</code>, and
          degrees-minutes-seconds (DMS) like
          {' '}<code className="bg-tint/10 px-1.5 py-0.5 rounded text-accent text-sm">48&deg; 51&apos; 30.3&quot; N</code>.
          ...
          <Link href="/coordinates-converter" className="text-accent hover:underline font-semibold">Coordinates Converter tool</Link>.
        </p>

        <div className="glass rounded-2xl p-5 mt-6 ring-1 ring-accent/30 bg-accent/5">
          <p className="text-sm text-fg-muted">
            <strong className="text-fg">Quick action:</strong> Use our free{' '}
            <Link href="/coordinates-converter" className="text-accent hover:underline font-semibold">Coordinates Converter</Link>{' '}
        ...
        <ul className="mt-3 space-y-2 text-fg-muted list-disc list-inside">
          <li>Sydney Opera House &mdash; <code className="bg-tint/10 px-1.5 py-0.5 rounded text-accent text-sm">-33.8568, 151.2153</code> in DD &harr; <code className="bg-tint/10 px-1.5 py-0.5 rounded text-accent text-sm">33&deg; 51&apos; 24.5&quot; S, 151&deg; 12&apos; 55.1&quot; E</code> in DMS. The S flips the sign, not the magnitude.</li>
          <li>Statue of Liberty &mdash; <code className="bg-tint/10 px-1.5 py-0.5 rounded text-accent text-sm">40.6892, -74.0445</code> in DD &harr; <code className="bg-tint/10 px-1.5 py-0.5 rounded text-accent text-sm">40&deg; 41&apos; 21.1&quot; N, 74&deg; 2&apos; 40.2&quot; W</code> in DMS. North is positive, West is negative.</li>
        </ul>
        ...
        <p className="mt-3 text-fg-muted leading-relaxed">
          ...
          or {' '}
          <Link href="/gps-coordinates" className="text-accent hover:underline font-semibold">GPS Coordinates</Link>.
        </p>

        <h2 className="font-display text-2xl font-bold mt-10">Related guides</h2>
        <ul className="mt-3 space-y-2 text-fg-muted list-disc list-inside">
          <li><Link href="/coordinates-converter" className="text-accent hover:underline">Coordinates Converter (interactive tool)</Link></li>
