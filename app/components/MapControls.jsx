...
export function LocateButton({ pos, onLocate }) {
  ...
  return (
    <button
      ...
      className="absolute z-[1000] bottom-5 right-5 glass-strong text-fg hover:text-accent rounded-full px-4 py-2.5 text-sm font-semibold flex items-center gap-2 transition shadow-lg"
    >
...
export function CopyFloating({ pos, onCopied }) {
  return (
    <button
      ...
      className="absolute z-[1000] bottom-5 left-5 glass-strong text-fg hover:text-accent rounded-full p-2.5 transition shadow-lg"
    >
