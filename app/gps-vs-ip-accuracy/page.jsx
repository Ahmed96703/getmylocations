...
export const metadata = {
  ...
  alternates: { canonical: '/gps-vs-ip-accuracy' },
  openGraph: {
    title: 'GPS vs IP Accuracy — Which Is More Precise?',
    description: "GPS vs IP geolocation compared. Accuracy tables, when each method fails, how VPNs affect location, and which one to use for which task.",
  ...
  return (
    <main role="main" className="max-w-3xl mx-auto px-5 py-12 prose-invert">
      <article>
        ...
        <div className="mt-4 glass rounded-2xl p-5 ring-1 ring-line overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead>
              <tr className="text-left text-accent uppercase tracking-wider text-xs">
            ...
            <tbody className="text-fg-muted">
              <tr className="border-t border-line">
                <td className="py-3 pr-4 font-semibold text-fg">GPS (outdoor)</td>
              ...
              <tr className="border-t border-line">
                <td className="py-3 pr-4 font-semibold text-fg">Wi-Fi positioning</td>
              ...
              <tr className="border-t border-line">
                <td className="py-3 pr-4 font-semibold text-fg">Cell tower</td>
              ...
              <tr className="border-t border-line">
                <td className="py-3 pr-4 font-semibold text-fg">IP geolocation</td>
        ...
        <p className="mt-3 text-fg-muted leading-relaxed">
          ...
          physics, read our <Link href="/blog/how-gps-works" className="text-accent hover:underline">how GPS works</Link> guide.
        </p>
        ...
        <p className="mt-3 text-fg-muted leading-relaxed">Concrete examples:</p>
        <ul className="mt-3 space-y-2 text-fg-muted list-disc list-inside">
          <li>
        ...
        <p className="mt-3 text-fg-muted leading-relaxed">
          ...
          {' '}<Link href="/" className="text-accent hover:underline">GetMyLocations</Link> on a desktop,
        ...
        <div className="mt-4 grid sm:grid-cols-2 gap-5">
          <div className="glass rounded-2xl p-5 ring-1 ring-line">
            <h3 className="font-display text-lg font-semibold text-fg">GPS fails when&hellip;</h3>
            <ul className="mt-3 space-y-2 text-fg-muted text-sm list-disc list-inside">
          ...
          <div className="glass rounded-2xl p-5 ring-1 ring-line">
            <h3 className="font-display text-lg font-semibold text-fg">IP fails when&hellip;</h3>
            <ul className="mt-3 space-y-2 text-fg-muted text-sm list-disc list-inside">
            ...
            <p className="mt-3 text-fg-muted text-sm">
              <strong className="text-fg">Fix:</strong> grant precise browser location, or disable the VPN if you only need country-level accuracy. Step-by-step in our
        ...
        <ul className="mt-3 space-y-3 text-fg-muted list-disc list-inside">
          <li>
        ...
        <p className="mt-3 text-fg-muted leading-relaxed">
          ...
          {' '}<Link href="/" className="text-accent hover:underline font-semibold">GetMyLocations</Link> and
