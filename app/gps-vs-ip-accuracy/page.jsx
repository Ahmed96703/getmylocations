    ...
    <main role="main" className="max-w-3xl mx-auto px-5 py-12 prose-invert">
      <article>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          physics, read our <Link href="/blog/how-gps-works" className="text-electric-400 hover:underline">how GPS works</Link> guide.
        </p>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          {' '}<Link href="/" className="text-electric-400 hover:underline">GetMyLocations</Link> on a desktop,
        ...
        <div className="mt-4 grid sm:grid-cols-2 gap-5">
          ...
          <div className="glass rounded-2xl p-5 ring-1 ring-white/10">
            ...
            <p className="mt-3 text-slate-300/90 text-sm">
              ...
              {' '}<Link href="/fix-location-not-working" className="text-electric-400 hover:underline">troubleshooting guide</Link>.
            </p>
          </div>
        </div>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          {' '}<Link href="/" className="text-electric-400 hover:underline font-semibold">GetMyLocations</Link> and
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          ...
          <li><Link href="/reverse-geocoding" className="text-electric-400 hover:underline">Reverse geocoding &mdash; coordinates to address</Link></li>
