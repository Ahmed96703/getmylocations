...
export default function Privacy() {
  return (
    <main role="main" className="max-w-3xl mx-auto px-5 py-12 prose-invert">
      ...
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        Some tools also call <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">navigator.geolocation.watchPosition</code>,
      ...
      <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
        <li>
          ...
          <a className="text-electric-400 hover:underline" href="https://www.bigdatacloud.com/privacy-and-cookie-policy" target="_blank" rel="noopener">bigdatacloud.com/privacy-and-cookie-policy</a>.
        </li>
        <li>
          <strong>OpenStreetMap Nominatim</strong> — used by the Address Finder and as
          a fallback elsewhere. Their privacy policy is at{' '}
          <a className="text-electric-400 hover:underline" href="https://wiki.osmfoundation.org/wiki/Privacy_Policy" target="_blank" rel="noopener">wiki.osmfoundation.org/wiki/Privacy_Policy</a>.
        </li>
      </ul>
      <p className="mt-3 text-slate-300/90 leading-relaxed">
      ...
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        ...
        <a className="text-electric-400 hover:underline" href="https://wiki.osmfoundation.org/wiki/Privacy_Policy" target="_blank" rel="noopener">OpenStreetMap</a>{' '}
        and{' '}
        <a className="text-electric-400 hover:underline" href="https://carto.com/privacy/" target="_blank" rel="noopener">CARTO</a>.
      </p>

      <h2 className="font-display text-2xl font-bold mt-10">4. IP lookups (IP Location tool)</h2>
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        The IP Location tool calls the public{' '}
        <a className="text-electric-400 hover:underline" href="https://ipapi.co/privacy/" target="_blank" rel="noopener">ipapi.co</a>{' '}
        endpoint. The IP you look up — your own when you click <em>Lookup my IP</em>,
      ...
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        ...
        analytics tool. Cloudflare&rsquo;s privacy policy:{' '}
        <a className="text-electric-400 hover:underline" href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener">cloudflare.com/privacypolicy</a>.
      </p>
      ...
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        ...
        may set cookies (for example <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">__gads</code>,{' '}
        <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">__gpi</code>, and{' '}
        <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">NID</code>) to serve
        ...
        <a className="text-electric-400 hover:underline" href="https://adssettings.google.com/" target="_blank" rel="noopener">adssettings.google.com</a>{' '}
        or opt out of personalized advertising network-wide at{' '}
        <a className="text-electric-400 hover:underline" href="https://www.aboutads.info/choices/" target="_blank" rel="noopener">aboutads.info/choices</a>.
      </p>
      <p className="mt-3 text-slate-300/90 leading-relaxed">
      ...
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        ...
        contact us at <a className="text-electric-400 hover:underline" href="mailto:hello@getmylocations.com">hello@getmylocations.com</a> and
      ...
      <p className="mt-3 text-slate-300/90 leading-relaxed">
        ...
        See the <Link href="/contact" className="text-electric-400 hover:underline">Contact page</Link> for response-time expectations.
      </p>
    </main>
  );
}
