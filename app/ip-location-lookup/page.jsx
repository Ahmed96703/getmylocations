    ...
    <main role="main" className="max-w-3xl mx-auto px-5 py-12 prose-invert">
      <article>
        ...
        <p className="mt-2 text-slate-300/90 leading-relaxed">
          Easiest by far. Open <Link href="/" className="text-electric-400 hover:underline">GetMyLocations</Link> and
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          Open <Link href="/" className="text-electric-400 hover:underline font-semibold">GetMyLocations</Link>. Your
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          ...
          <li><Link href="/blog/how-gps-works" className="text-electric-400 hover:underline">How GPS works &mdash; satellite math</Link></li>
        </ul>
      </article>
    </main>
  );
