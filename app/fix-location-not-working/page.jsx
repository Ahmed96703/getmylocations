...
export default function FixLocationNotWorking() {
  return (
    <main role="main" className="max-w-3xl mx-auto px-5 py-12 prose-invert">
      <article>
        <p className="text-xs uppercase tracking-[0.18em] text-electric-400 font-semibold">Troubleshooting Guide</p>
        ...
        <div className="mt-5 glass rounded-2xl p-5 ring-1 ring-white/10">
          <ol className="space-y-3 text-slate-300/90">
            <li><strong className="text-slate-100">Browser shows a small red &ldquo;blocked&rdquo; icon in the address bar</strong> &rarr; you previously denied the permission prompt. Jump to <a className="text-electric-400 hover:underline" href="#chrome">re-enabling browser location</a>.</li>
            <li><strong className="text-slate-100">Page says &ldquo;location permission denied&rdquo; or never prompts</strong> &rarr; the site is blocked by your browser&apos;s site settings. Same fix.</li>
            <li><strong className="text-slate-100">Map shows the wrong city or country</strong> &rarr; either a VPN/proxy is rewriting your IP or you only granted IP-level (not GPS-level) accuracy. Jump to <a className="text-electric-400 hover:underline" href="#wrong-city">wrong city showing</a>.</li>
            <li><strong className="text-slate-100">Coordinates fluctuate wildly every few seconds</strong> &rarr; GPS signal is weak (indoors, surrounded by glass/metal) or you&apos;re on Wi-Fi-only positioning. Jump to <a className="text-electric-400 hover:underline" href="#weak-signal">weak signal fixes</a>.</li>
            <li><strong className="text-slate-100">Nothing happens — page just hangs</strong> &rarr; the geolocation API is being blocked at the OS or network level. Jump to <a className="text-electric-400 hover:underline" href="#nothing">advanced diagnostics</a>.</li>
          </ol>
        </div>
        ...
        <ol className="mt-3 space-y-2 text-slate-300/90 list-decimal list-inside">
          <li>Open the site whose location is broken (e.g. <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">getmylocations.com</code>).</li>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          location disabled globally. Open <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">chrome://settings/content/location</code> in the address bar
        ...
        <h3 className="font-display text-lg font-semibold mt-6 text-slate-100">macOS Safari</h3>
        ...
        <h3 className="font-display text-lg font-semibold mt-6 text-slate-100">iOS Safari (iPhone / iPad)</h3>
        <ol className="mt-2 space-y-2 text-slate-300/90 list-decimal list-inside">
        ...
        <ol className="mt-3 space-y-2 text-slate-300/90 list-decimal list-inside">
          ...
          <li>Alternative: <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">about:preferences#privacy</code> &rarr; scroll to Permissions &rarr; click <strong>Settings&hellip;</strong> next to Location &rarr; remove the blocked entry &rarr; Save Changes.</li>
        ...
        <p className="mt-4 text-slate-300/90 leading-relaxed">
          ...
          For more on the difference, read our <Link href="/blog/what-is-ip-location-and-how-accurate" className="text-electric-400 hover:underline">guide to IP location accuracy</Link>.
        </p>
        ...
        <ol className="mt-3 space-y-3 text-slate-300/90 list-decimal list-inside">
          <li>
          ...
          <li>
            ...
            opening a site via plain <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm">http://</code> or
            <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400 text-sm"> file://</code>, the call silently fails.
          </li>
          <li>
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          ...
          the <Link href="/" className="text-electric-400 hover:underline font-semibold">GetMyLocations</Link> tool. It runs entirely in your browser, requests the
        ...
        <p className="mt-3 text-slate-300/90 leading-relaxed">
          Still stuck? Email us at <a className="text-electric-400 hover:underline" href="mailto:hello@getmylocations.com">hello@getmylocations.com</a> with your browser,
        ...
        <ul className="mt-3 space-y-2 text-slate-300/90 list-disc list-inside">
          <li><Link href="/blog/what-is-ip-location-and-how-accurate" className="text-electric-400 hover:underline">What is IP location and how accurate is it?</Link></li>
          <li><Link href="/blog/how-gps-works" className="text-electric-400 hover:underline">How GPS works — the satellite math behind your coordinates</Link></li>
          ...
          <li><Link href="/gps-coordinates-finder" className="text-electric-400 hover:underline">GPS coordinates finder — complete guide</Link></li>
        </ul>
      </article>
    </main>
  );
