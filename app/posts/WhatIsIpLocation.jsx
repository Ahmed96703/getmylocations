  ...
  return (
    <article className="prose-invert">
      ...
      <ul className="mt-3 space-y-1.5 text-slate-300/90 list-disc list-inside">
        <li><strong>IPv4</strong> &mdash; four numbers separated by dots, e.g. <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400">142.250.190.78</code></li>
        <li><strong>IPv6</strong> &mdash; eight blocks of hex digits, e.g. <code className="bg-white/10 px-1.5 py-0.5 rounded text-electric-400">2001:0db8:85a3::8a2e:0370:7334</code></li>
      </ul>
      <p className="mt-3 text-slate-300/90 leading-relaxed">
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody className="text-slate-300/90">
            <tr className="border-b border-white/5"><td className="py-2 pr-4">Typical accuracy</td><td className="py-2 pr-4">5&ndash;50 km</td><td className="py-2">3&ndash;5 m</td></tr>
            ...
            <tr className="border-b border-white/5"><td className="py-2 pr-4">Permission needed</td><td className="py-2 pr-4">No (visible by default)</td><td className="py-2">Yes</td></tr>
